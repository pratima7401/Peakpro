...
<body>
    ...
    <header>
     ...
     <div class="container">
        ...
        <form id="inquiryForm" action="inquiry_db.php" method="POST" class="form-container mt-5">
            <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="message" name="message" rows="3" required></textarea> <!-- Ensure name is "message" -->
        </div>
